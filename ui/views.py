...
from ui.models import Postlogin,Notices
def index(request):
    u=Notices.objects.all()
    noticeslist=[]
    for i in u:
        obj = {
            'id': i.pk,
        ...
        noticeslist.append(obj)

    print(noticeslist)
    return render(request,'ui/index.html',{'noticeslist':noticeslist})
...
def notices(request,id):
    ...
    print(content)
    return render(request,"ui/notices.html",{"content":content})